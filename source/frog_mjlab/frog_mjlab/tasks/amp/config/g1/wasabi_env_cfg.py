...
def g1_wasabi_flat_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  ...
  return make_wasabi_env_cfg(
    g1_amp_env_cfg(play=play),
    motion_files=os.path.abspath(os.path.join(os.path.dirname(__file__), "motions", "WalkandRun")),
    body_names=wasabi_body_names,
