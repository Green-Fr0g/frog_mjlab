...
class FrogMjlabOnPolicyRunner(OnPolicyRunner):
  """mjlab runner adapter backed by frog_rl."""
  ...
  def __init__(
    ...
    # Strip None-valued optional configs so frog_rl MLPModel doesn't receive them.
  ...
  def export_policy_to_onnx(
    ...
    """Export policy to ONNX format using the legacy torch exporter path."""
  ...
  def save(self, path: str, infos=None) -> None:
    """Save checkpoint with mjlab environment state."""
  ...
  def load(
    ...
    """Load checkpoint and restore mjlab environment state."""
